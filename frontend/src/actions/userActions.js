...
const login = (email, password) => async(dispatch) => {
    ...
    // Requête POST pour se connecter avec les informations d'identification fournies
        ...
        localStorage.setItem('userInfo', JSON.stringify(data))
            ...
            // Dispatch de l'action d'échec avec le message d'erreur approprié
        dispatch({
...
export const logout =() => (dispatch) => {
      // Suppression des informations de l'utilisateur du stockage local
    localStorage.removeItem('userInfo')
      // Dispatch des actions de réinitialisation
...
export const register = (name, email, password) => async(dispatch) => {
    ...
    // Requête POST pour créer un nouvel utilisateur avec les informations fournies
    ...
    // Dispatch des actions de succès et stockage des informations de l'utilisateur dans le stockage local
        dispatch({
            type: USER_LOGIN_SUCCESS,
            payload: data
        })
...
// ... (Le reste des actions suit le même modèle)

// Export de l'action de connexion
