    ...
    return (
		...
		<div className="login-content">
			...
			<h1>Identifiant</h1>
            	...
            	<input type="submit" className="btna" value="Accéder" />
               
              <div className='div-forgot'>
                              <span>Mot de passe </span>
                         <Link className ='text-forgot'  to ='/forgot'>Oublié? </Link>
                         
                         </div>
              <Link className="createAcc" to={redirect ? `/register?redirect=${redirect}` : '/register'}>Créer mon compte maintenant <BsArrowRight size="25"/></Link>
