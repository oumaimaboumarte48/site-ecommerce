        ...
        <div className="placeorder">
            ...
            <div className="informations-placeorder">
                ...
                <div>
                   ...
                   {cart.cartItems.length === 0 ? <p>Votre panier est vide</p>:
                ...
                <div className="your-products">
                        ...
                        <div className="cart-summ">
                            <h1>Récapitulatif de la commande</h1>
                                ...
                                <h3>Articles: </h3><p>${cart.itemsPrice}</p>
                                <h3>Expédition: </h3><p>${cart.shippingPrice}</p>
                                <h3>Tax: </h3><p>${cart.taxPrice}</p>
                                <h3>Total: </h3><p>${cart.totalPrice}</p>
                                <div className="div-placeorder-btn"> 
                                    <button className="placeorder-btn" onClick = {Placeorderhanlder}>Passer la commande</button>
                                    {error && error}
                                </div>
                              </div>
