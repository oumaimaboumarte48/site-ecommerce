          ...
          <div>
            ...
            <div className ='formedit'>
                ...
                <div className="input-div zz">
                   <div className="div">
                   <InputGroup>
                      <Input type="text" value={name}  placeholder="entrez votre nom"  onChange={(e) => setName(e.target.value)}/>
           		...
           		<div className="input-div one">
           		   <div className="div">
           		   		<InputGroup>
                              <Input  type="email" value={email} placeholder="entrez l'é-mail" onChange={(e) => setEmail(e.target.value)} />
