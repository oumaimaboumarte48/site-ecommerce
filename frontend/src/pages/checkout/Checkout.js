            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="billing-check">
                        ...
                        <label for="address" className="this-label">Adresse</label><br />
                    ...
                    <div className="payment-check">
                        ...
                        <input onChange = {(e)=> {setcarddetails(true) ; setPayment('card')}} checked = {carddetails}  type="radio" name="payment" id="card"/><label for="card" className="this-label">Carte de crédit</label>
                        ...
                        <div><label for="name-card" className="this-label">Nom sur la carte</label><br />
                        <Input variant="flushed" id="name-card" placeholder="Oumaima Boumarte"/></div>
                        <div><label for="number-card" className="this-label">Numéro de Carte de Crédit</label><br />
                        <Input variant="flushed" id="number-card"  placeholder="3333-1111-8888-2222"/></div>
                        <div><label for="expir-mt-card" className="this-label">Mois d'exp.</label><br />
                        <Input variant="flushed" id="expir-mt-card"  placeholder="January"/></div>
                        <div className="exp-ye-cvv-check">
                            <div><label for="exp-year" className="this-label">Année d'expérience</label>
                        ...
                        <div class="confirm">
                          <input type="submit" className="confirm-check" value="endroit pour commander"/>
                        </div>
                    </div>
                    </form>
