...
const Products = ({history,match}) => {
    ...
    return (
        ...
        {loading || loadingDelete || loadingCreate ?  <div className='loading'>
                   ...
                   <>
                                      <Button leftIcon = {<CgAdd size = '20' />} className = 'ADDBUTTON' colorScheme ='green' onClick = {createproducthandler}>Ajouter</Button>

                   <Box overflowX = 'auto'>
                   <Table  className = 'productusers' variant="striped">
                       <Thead>
                        <Tr>
                            <Th w = '10%'>Identifiant</Th>
                            <Th  w = '20%'>Nom</Th>
                            <Th   w = '20%'>Prix</Th>
                            <Th  w = '20%'>Catégorie</Th>
                            <Th  w = '10%'></Th>
                        </Tr>
                      </Thead>
                      <Tbody>
                                ...
                                <Tr key = {product._id}>
                                    ...
                                    <Td>
                                        ...
                                        <Link to ={ `/admin/product/${product._id}/edit`}>
                                             <Button leftIcon = {<AiOutlineEdit size = '16' />} colorScheme ='green' size="xs"  >MODIFIER</Button>
                                        </Link>
