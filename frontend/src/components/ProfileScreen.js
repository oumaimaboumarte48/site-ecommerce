               ...
               <AiOutlineEdit size ='26' className = 'edit' onClick = {nameinputfocus}/>
           		...
           		<div className="input-div one">
           		   ...
           		   <div className="div">
           		   		...
           		   		<input type="text" value={email} readOnly = {isEditableemail} ref = {emailinput} className="inputa" placeholder="Entrez l'e-mail" onChange={(e) => setEmail(e.target.value)} />
           		   </div>
              ...
              emailinput.current.focus()
           		...
           		<div className="input-div pass">
           		   ...
           		   <div className="div">
           		    	...
           		    	<input type="password" value={password} required className="inputa" placeholder="Entrer le mot de passe" onChange={(e) => setPassword(e.target.value)}/>
            	   </div>
            	</div>
                ...
                <input type="soumettre" className="btna2" value="Modifier"/>
