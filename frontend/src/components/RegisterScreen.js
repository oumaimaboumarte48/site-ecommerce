			...
			<form onSubmit={submitHandler}>
                ...
                <div className="input-div zz">
                   ...
                   <div className="div">
           		   		...
           		   		<input type="text" value={name} className="inputa" placeholder="entrez votre nom"  onChange={(e) => setName(e.target.value)}/>
           		   </div>
           		...
           		<div className="input-div one">
           		   ...
           		   <div className="div">
           		   		...
           		   		<input type="text" value={email} className="inputa" placeholder="entrez l'é-mail" onChange={(e) => setEmail(e.target.value)} />
           		   </div>
           		</div>
                ...
                <input type="submit" className="btna2" value="s'inscrire"/>
                <br />
                Avoir un compte? {' '}
            	<Link to={redirect ? `/login?redirect=${redirect}` : '/login'}>Accéder</Link>
